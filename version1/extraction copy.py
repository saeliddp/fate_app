...
dbx = dropbox.Dropbox('VArGdI5OUcAAAAAAAAAAiLo_DGkTj0h4hPqBCgRMm1KtK2mhm3u2M1Wd511HmrLx')
...
def extractFromFile(file_name, num_snippets):
    with open("txtdata2/" + file_name, "wb") as f:
        metadata, res = dbx.files_download(path="/repeat_rerank/1/" + file_name)
        f.write(res.content)

    file = open("txtdata2/" + file_name, "r")
...
print(extractFromFile('0g.txt', 5))
